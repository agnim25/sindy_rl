...
# ) -> Union[Tuple[float, float, List[]], Tuple[List[float], List[int]]]:
    """
    ...
    episode_rewards, episode_lengths, episode_states, episode_actions = [], [], [], []
    ...
    if return_episode_rewards:
        return episode_rewards, episode_lengths, episode_states, episode_actions
    return mean_reward, std_reward, episode_states, episode_actions
