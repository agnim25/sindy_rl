...
# Function taken from https://github.com/deepmind/dm_control
def sigmoids( x, value_at_1, sigmoid):
...
def tolerance(x, bounds=(0.0, 0.0), margin=0.0, sigmoid='gaussian',
    ...
    if margin == 0:
        ...
        value = np.where(in_bounds, 1.0, sigmoids(d, value_at_margin, sigmoid))
