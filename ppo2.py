    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                trainer = tf.train.AdamOptimizer(learning_rate=self.learning_rate_ph, epsilon=1e-5, beta1=0.0)
    ...
    def learn(self, total_timesteps, callback=None, log_interval=1, tb_log_name="PPO2",
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for update in range(1, n_updates + 1):
                ...
                ############ custom code: dho@caltech.edu
                rew = np.mean([ep['r'] for ep in ep_infos])
                try:
                    lr_now = self.learning_rate(frac, rew)  #make the learning rate dependend on the episode reward
                except TypeError:
