...
for s_o in ode_sol:
    for s_t in task:
        for s_r in rew:
            ...
            register(
                id='ct_{}-v0'.format(get_name(s_o, s_t, s_r)),
                entry_point='gym_custom.envs:CTCartPoleEnv',
                kwargs={'config': config_i}
            )
...
for s_o in ode_sol:
    for s_t in task:
        for s_r in rew:
            ...
            register(
                id='ct_{}-v1'.format(get_name(s_o, s_t, s_r)),
                entry_point='gym_custom.envs:CTCartPoleEnv',
                kwargs={'config': config_i}
            )
...
register(
    id='mountaincar',
    entry_point='gym_custom.envs:CTMountainCarEnv'
)

register(
    id='swimmer',
    entry_point='gym_custom.envs:SwimmerEnv'
)